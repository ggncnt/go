...
1. Clone horizon's source:  `go get github.com/stellar/go && cd $GOPATH/src/github.com/ggncnt/go/`
2. Under the project folder, download external dependencies: `glide install`
3. Build the binary: `go install github.com/ggncnt/go/services/horizon`
