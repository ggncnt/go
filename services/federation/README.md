...
[Prebuilt binaries](https://github.com/ggncnt/go/releases) of the federation server are available on the [releases page](https://github.com/ggncnt/go/releases).
...
```
go get -u github.com/ggncnt/go/services/federation
```
